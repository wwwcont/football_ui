    ...
    <Link to={`/matches/${match.id}`} className="block rounded-xl border border-zinc-800 bg-zinc-900 px-3 py-3">
      ...
      <div className="mt-2 grid grid-cols-[1fr_auto_1fr] items-center gap-2">
        <div className="flex min-w-0 items-center gap-2">
          <TeamLogo team={homeTeam} className="h-6 w-6 rounded-full border border-zinc-700 object-cover" />
        ...
        <div className="flex min-w-0 items-center justify-end gap-2">
          ...
          <TeamLogo team={awayTeam} className="h-6 w-6 rounded-full border border-zinc-700 object-cover" />
        </div>
      </div>
